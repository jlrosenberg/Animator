...
public class KeyFrame implements Comparable{
    ...
    public KeyFrame(int tick, int x, int y, int r, int g, int b, int width, int height){
        state=new ShapeState(x,  y, r, g, b, width, height);
        this.tick=tick;
    }
    ...
    public int compareTo(Object o) {
        ...
        if(other.getTick()<tick){
            return -1;
        }else if(other.getTick()==tick){
            return 0;
        }else{
            return 1;
        }
